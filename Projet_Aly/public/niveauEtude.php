...
<div class="container">
  ...
  <option selected>Selectionner un niveau d'enseignement</option>
  <option value="1">Enseignement primaire</option>
  <option value="2">Enseignement secondaire</option>
  <option value="3">Enseignement superieur</option>
</select>
    <!-- <div class="a">
<select class="form-select" aria-label="Default select example">
		...
		<div class="main-box clearfix">
			<div class="table-responsive">
				<table class="table user-list">
					<thead>
						<tr>
							<th><span>Nom niveau</span></th>
							<th><span>Nombre de classe</span></th>
